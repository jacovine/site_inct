...
Ainda que a tabela obtida não esteja sendo aqui impressa, os dados gerados permitem que se construa um primeiro retrato sobre o total de pessoas por raça/cor no município de São Paulo em 2010. É importante ressaltar, porém, que tão importante quanto a geração de dados é a comunicação dos achados - algo que, aos poucos e na medida do possível, será explorado no presente texto. Nesse sentido, para tornar a tabela mais concisa e visualmente atrativa, a seguir uma nova versão é apresentada. Nela, como pode ser visto, existem menos variáveis, os nomes das variáveis são mais intuitivos e os dados foram reordenados - do grupo com mais pessoas para o que possui menos.
...
## Analisando os dados: avançando no entendimento sobre a distribuição da raça/cor nas diferentes partes do território municipal
